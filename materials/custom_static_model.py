...
class CustomStaticModel(RWMaterial):
    material_name = "Custom Static Model"
    ...
    def set_pointer_property(cls):
        cls.material_data_CustomStaticModel = PointerProperty(
            type=CustomStaticModel#StaticModel
        )

    @staticmethod
    def get_material_data(rw4_material):
        return rw4_material.material_data_CustomStaticModel

    @staticmethod
    def draw_panel(layout, rw4_material):

        data = rw4_material.material_data_CustomStaticModel
    ...
    def get_material_builder(exporter, rw4_material):
        material_data = rw4_material.material_data_CustomStaticModel
    ...
    def set_texture(obj, material, slot_index, path):
        if slot_index == 0:
            material.rw4.material_data_CustomStaticModel.diffuse_texture = path
            ...
            material.rw4.material_data_CustomStaticModel.diffuse_2_texture = path
            ...
            material.rw4.material_data_CustomStaticModel.normal_texture = path
